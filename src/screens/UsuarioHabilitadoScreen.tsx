      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            {!loading && medios.map((m) => (
              <View key={m.id} style={styles.metodo}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.metodoTitle}>{m.aliasDescripcion}</Text>
                  <Text style={styles.metodoSub}>{m.moneda} · {m.tipo}</Text>
                </View>
                <CheckCircleIcon size={18} color={m.verificado ? Colors.green : Colors.gray2} />
              </View>
            ))}
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  metodo:      { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.white, borderRadius: 14, padding: 14, marginTop: 12 },
