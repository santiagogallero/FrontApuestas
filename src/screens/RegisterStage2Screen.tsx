...
interface RegisterStage2ScreenProps {
  onNavigate: NavigateFn;
  params?: ScreenParams['registerStage2'];
}
...
export function RegisterStage2Screen({ onNavigate, params }: RegisterStage2ScreenProps) {
    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.content}>
          ...
          <AppButton title="Enviar documentación" icon="→" onPress={handleSubmit} loading={loading} />
